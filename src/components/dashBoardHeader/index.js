      ...
      <Tooltip
        ...
        componentsProps={{
          ...
          <div className="titleContainer">
            ...
            {remainHoursTotal[0] < 0 ?
              <div className='remainInfo'>
                You are <strong><i>{remainHoursTotal.join(':')} (h:m:s)</i></strong> behind schedule.
                It is recommended to work an extra <strong><i>{remainHoursInDay.join(':')} (h:m:s)</i></strong> per a day to normalize working hours for the remaining <strong><i>{remainDays}</i></strong> days.
              </div> :
              null}
          </div>
        }>
